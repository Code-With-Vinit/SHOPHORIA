...
const Carousel = () => {
  ...
  const SampleNextArrow =(props)=>{
        ...
        return (
            <div onClick={onClick} className={`arrow ${className}`} style={{zIndex:3}}>
                <AiOutlineArrowRight className="arrows" style={{...style,display:"block",borderRadius:"50px",background:"#f53347",color:"white",
                ...
                return <div key={index} className="bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10">
                    <div className="flex gap-10 justify-center h-[600px] items-center px-4">
                        <div className="space-y-6">
                            <h3 className="text-red-500 font-semibold font-sans">Powering Your World with the Best in Lifestyle</h3>
                        ...
                        <div>
                            <img src={item.image} alt={item.title} className="rounded-full w-[400px] h-[400px] object-contain hover:scale-105 transition-all shadow-2xl shadow-red-400 bg-white"/>
                        </div>
